...
if __name__ == '__main__':
    baseDir = 'F:/lutaiwang/定位实验/ppp_results/picked_stations/'
    target_dir = 'H/lutaiwang/定位试验/ppp_solution_results/conventional/'
    time_xyz_conventional = 'time_xyz_conventional'
    time_xyz_lstmztd = 'time_xyz_lstmztd'
    time_xyz_periodztd = 'time_xyz_periodztd'
    stations = ['xzzb', 'jlcl', 'xjke', 'fjwy', 'yncx', 'snak']
    index = 0
    epoches = []
    xs = []
    ys = []
